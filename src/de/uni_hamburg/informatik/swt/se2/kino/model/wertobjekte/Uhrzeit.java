...
public final class Uhrzeit implements Comparable<Uhrzeit> {
    ...
    /**
     * Prüft, ob die übergebenen Stunden im Bereich 0..23 liegen und die übergebenen
     * Minuten im Bereich 0..59
     * 
     ...
     * 
     * @return den Stundenanteil der Uhrzeit
     * 
     ...
     * 
     * @return den Minutenanteil der Uhrzeit
     * 
     ...
     * 
     * @return die Minuten seit Erstellung der Uhrzeit
     * 
     * @require start != null
     * @ensure result >= 0
     */
     ...
     * 
     * @return die Uhrzeit als formatierten String
     * 
     * @ensure result != null
     */
