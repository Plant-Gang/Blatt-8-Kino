...
public final class Datum implements Comparable<Datum> {
     ...
     * 
     * Alle Exemplare der Klasse Datum teilen sich ein veränderliches
     * Calender-Objekt.
     * Dieses Vorgehen ist extrem untypisch für Wertobjekte.
     * Also nehmt diese Klasse bitte nicht als Musterbeispiel für Wertobjekte!
     ...
     * Auch wenn es nun neue Optionen gibt, ist das hier ein typisches Beispiel für
     * Code, der in der Praxis in älteren Projekten noch zu finden ist.
     */
     ...
     * @param jahr  Das Jahr
     * 
     * @return das Datum, was zu den Parametern gehört
     * 
     ...
     * 
     * @return Das vorherige Datum des aktuellen Datums
     * 
     ...
     * 
     * @return das auf das Datum folgende Datum
     * 
     ...
     * 
     * @return die Tage seit Erstellung des Datums
     * 
     * @require start != null
     */
